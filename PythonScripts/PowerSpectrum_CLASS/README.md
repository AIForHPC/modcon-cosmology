...
Pre-requisite - Run the CLASS code to generate the transfer function and power spectrum files. See [ForNyx](https://github.com/nataraj2/class_public/tree/master/ForNyx).
